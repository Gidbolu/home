                    ...
                    <div className="container">
                        <div className="row home-flex">
                            <div className="col col-lg info">
                                ...
                                <div>
                                    <button className="btn btn-lg btn-dark me-2 fs-3" type="button"><Link to={"https://tally.so/r/mJDoaJ"} className="nav-link active" >Enroll now for N70,000</Link></button>
