                    ...
                    <div className="container">
                        <div className="row home-flex">
                            <div className="col col-lg info">
                                ...
                                <div>
                                    <button className="btn btn-lg btn-dark me-2 fs-3" type="button"><Link to={"https://docs.google.com/forms/d/e/1FAIpQLScshIxOu3MDys4IpMltlUKYcSjWbwFeXYQ_Exo2jZAp3Aw6Aw/viewform?usp=pp_url"} target='_blank' className="nav-link active" >Enroll now for N80,000</Link></button>
